...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'white'}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'#586e75'} # '#657b83'}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		...
		# "wan_ip 24 255"
		# "vcs_branch brightred default"
		# "vcs_compare brightred 255"
		# "vcs_staged 64 255"
		# "vcs_modified brightred 255"
		# "vcs_others 245 0"
	)
fi
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		# "mailcount 9 255"
		# "now_playing 234 37 ${TMUX_POWERLINE_SEPARATOR_LEFT_BOLD}"
		# "cpu 240 136"
		# "load 237 167"
		...
		# "xkb_layout 125 117"
		# "date_day 235 136"
		"date blue black ${TMUX_POWERLINE_SEPARATOR_LEFT_BOLD}"
		"time blue black ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
